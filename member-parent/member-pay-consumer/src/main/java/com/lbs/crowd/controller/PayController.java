...
import com.lbs.crowd.config.PayProperties;
...
public class PayController {
	...
	*/
    ...
    public String generateOrder(HttpSession session, OrderVO orderVO) throws AlipayApiException {
        ...
        // 1.从Session 域获取orderProjectVO对象
        OrderProjectVO orderProjectVO = (OrderProjectVO) session.getAttribute("orderProjectVO");

        // 2.将orderProjectVO 对象和orderVO对象组装到一起
        ...
        return sendRequestToAilPay(orderNum,orderAmount,orderProjectVO.getProjectName(),orderProjectVO.getReturnContent());
    ...
    private String sendRequestToAilPay(String outTradeNo,Double totalAmount,String subject,String body) throws AlipayApiException {
