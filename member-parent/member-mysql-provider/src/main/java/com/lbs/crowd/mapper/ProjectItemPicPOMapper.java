...
import com.lbs.crowd.entity.po.ProjectItemPicPO;
import com.lbs.crowd.entity.po.ProjectItemPicPOExample;
...
public interface ProjectItemPicPOMapper {
    ...
    void insertPicPathList(@Param("detailPicturePathList") List<String> detailPicturePathList, @Param("projectId") Integer projectId);
}