...
<script type="text/javascript">
    ...
    $(function () {
        ...
        // 5.给新增模态框中的保存按钮添加单击函数
        $("#saveRoleBtn").click(function () {

            // ①获取用户在文本框中输入的角色名称
            // #addModel表示找到整个模态框
            // 空格表示在后代元素中继续查找
            // [name=roleName]表示匹配到name属性等于roleName的元素
        ...
        // 6.给页面上的“铅笔”按钮绑定单击响应函数，为了打开模态框
        // 传统的的时间绑定函数只能在第一页有效，翻页失效
       /* $(".pencilBtn").click(function () {
        ...
        // 临时测试代码
        /*var roleArray = [
            {roleId:5,roleName:"ASDF"},
            {roleId: 12,roleName: "riki"},
            {roleId:15,roleName:"qwe"}
        ];
        showConfirmModal(roleArray);*/

        // 8.点击确认模态框中的确定删除按钮执行删除
