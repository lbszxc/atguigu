                ...
                <div class="panel-body">
                    <form  action="admin/save.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="loginAcount" class="form-control" id="exampleInputId" placeholder="请输入登录账号">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword">登录密码</label>
                            <input type="text" name="userPassword" class="form-control" id="exampleInputPassword" placeholder="请输入登录密码">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName">用户昵称</label>
                            <input name="userName" type="text" class="form-control" id="exampleInputName" placeholder="请输入用户昵称">
                        </div>
                        <div class="form-group">
