...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        var properties = {
            ...
            // 指定用户点击“翻页”按钮时跳转页面的回调函数pageSelectCallback
            ...
            // 当前选中的页数
            // Pagination的内部是使用pageIndex来管理页码的，pageIndex的页码是从0开始的，
            // 而pageNum的页码从1开始，所以要减1
    ...
    // 回调函数的含义：声明出来以后不知自己调用，而是交给系统或框架调用
    // 用户点击“上一页、下一页、1、2、3......”这样的页码时调用这个函数实现页面跳转
    // pageIndex是Pagination传给我们的那个“从0”开始的页码
    function pageSelectCallback(pageIndex,JQuery) {
        ...
        // 由于每个页码按钮都是超链接，所以在这个函数最后要取消超链接的默认行为
        return false;
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="admin/to/add/page.html" class="btn btn-primary" style="float:right;" onclick="window.location.href='add.html'"><i class="glyphicon glyphicon-plus"></i> 新增</a>
                    <br>
                    <hr style="clear:both;">
                        ...
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                                <c:if test="${empty requestScope.pageInfo.list}">
                                    <tr>
                                        <td colspan="6" align="center">抱歉！没有查询您要找的数据！</td>
                                    </tr>
                                </c:if>
                                <c:if test="${!empty requestScope.pageInfo.list}">
